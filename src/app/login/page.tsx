...
export default function LoginPage() {
    ...
    const handleGoogleLogin = async () => {
        setIsLoading(true);
        try {
            // Lazy-load the Supabase client so it only initializes in the browser
    ...
    return (
        <div className="min-h-screen bg-[#E0FF00] flex items-center justify-center p-6 font-sans">
            <motion.div
            ...
            >
                ...
                <Button
                    ...
                    disabled={isLoading}
                    size="lg"
                    className="w-full bg-black text-white border-black hover:bg-zinc-800"
                >
                    {isLoading ? (
                        "Loading..."
                    ) : (
                ...
                <p className="text-center text-xs text-zinc-400 mt-6 font-medium">
                    Admin? Same login, different dashboard.
                </p>
            </motion.div>
        </div>
    );
